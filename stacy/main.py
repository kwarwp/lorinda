...
class Reticulo:
    ...
    def vai_reticulo(self):
        ...
        Elemento("https://i.imgur.com/YfSoVKE.png", x= 300, y=200, w=200, h=300, cena =sala_a.oeste)
        Elemento("https://i.imgur.com/YKNLls2.png", x= 500, y=200, w=200, h=300, cena =sala_a.oeste)
        ...
        Elemento("https://i.imgur.com/YKNLls2.png", x= 400, y=200, w=200, h=300, cena =sala_a.norte)
