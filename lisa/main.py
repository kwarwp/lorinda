...
class apresentacao():
    def __init__(self):
        ...
        self.maria= Elemento(img= MARIA, x=400, y=300, w=150, h=250)
        ...
        self.chefe=Elemento(img=CHEFE, x=200, y=390, w=200, h=150)
    ...
    def ciclone(self, *_):
        ...
        self.maria_double=Elemento(img=MARIA, x=400, y=300, w=150, h=250, cena=self.laboratorio,
