...
CELULA = "https://www.cientic.com/imagens/celgaler1.jpg"
...
class Fase2():
    ...
    def atravessa_membrana(self,*_):
        ...
        fala = Texto(self.membrana, "Tenho que atravessar a membrana plasmática para entrar na célula. Ainda bem que estou bem pequenininha e não possuo carga.", foi=maria_anda)
